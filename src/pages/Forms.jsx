            ...
            <div class="bg-white pb-5 pt-5 ">
              ...
              <div class="car-brand flex justify-between py-6 px-10 ">
                <div class="item-detail ">
                  <div>
                    <img className="car" src="../../public/images/s1.png" alt="" />
                  </div>
                  <div>
                    ...
                    <div className="modal-box bg-white text-black">
                      ...
                      <div className="modal-body p-2 ">
                        ...
                        <div className="form-control">
                          ...
                          <div class="item-detail ">
                              <div>
                                <img className="car" src="../../public/images/s2.png" alt="" />
                              </div>
                              <div>
                        ...
                        <div className="form-control">
                          ...
                          <div class="item-detail ">
                              <div>
                                <img className="car" src="../../public/images/s3.png" alt="" />
                              </div>
                              <div>
                        ...
                        <div className="form-control">
                          ...
                          <div class="item-detail ">
                              <div>
                                <img className="car" src="../../public/images/s4.png" alt="" />
                              </div>
                              <div>
